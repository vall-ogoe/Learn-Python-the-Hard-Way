...
class Death(Scene):
    ...
    quips = [
        ...
        "Such a luser.",
        "I have a small puppy better than this.",
        "You're wors than your Dad's jokes."
    ]
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                wall and pass out. You wake up shortly after and 
            ...
            print(dedent("""
                ...
                you know: Lbhe zbgure vf fb sng, jura fur fvgf nebhaq 
                gur ubhf fur fvgf nebhaq gur ubhfr. The Gothon stops, tries 
                not to laugh, then busts out laughing and can't move While he's laughing you run up and shoot him square 
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print(dedent("""
                ...
                Gothons blow up the ship from their ship and you di
                """))
            return 'death'
...
class TheBridge(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            49 take control of the ship. Each of them has an even ugli
    ...
    def enter(self):
        ...
        if int(guess) != good_pod:
            ...
            print(dedent("""
                ...
                The pod easily slides out into space heading to the planet below. As it flies to the planet, you look back and see your ship implode then explode like a bright star, taking out the Gothon ship at the same time. You won!
                """))
            return 'finished'
